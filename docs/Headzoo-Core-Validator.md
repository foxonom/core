...
* This class implements: [Headzoo\Core\ValidatorInterface](Headzoo-Core-ValidatorInterface.md)
...
### Headzoo\Core\Validator::validateRequired
...
```php
public mixed Headzoo\Core\Validator::validateRequired(array $values, array $required, $allowEmpty)
```
...
```php
public string Headzoo\Core\Validator::getClassName()
```
...
global namespace.
```php
public string Headzoo\Core\Validator::getNamespaceName()
```
...
```php
protected mixed Headzoo\Core\Validator::toss(string $exception, string $message, int $code)
```
...
```php
private string Headzoo\Core\Validator::interpolate(string $message, array $context)
```
...
* This method is defined by [Headzoo\Core\ValidatorInterface](Headzoo-Core-ValidatorInterface.md)
