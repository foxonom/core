    ...
    extends Obj
{
     ...
     * @throws \Headzoo\Core\Exceptions\UndefinedConstantException When the child class does not have a constant with the given $value
     * @throws \Headzoo\Core\Exceptions\InvalidArgumentException   When $value is an object, but not an instance of this class.
     */
     ...
     * 
     * @return array
     * @throws \Headzoo\Core\Exceptions\LogicException When the child class defines constants with non-string values
     * @throws \Headzoo\Core\Exceptions\UndefinedConstantException When the child class does not define a __DEFAULT constant
     */
