<?php
namespace Headzoo\Core\Tests;
use Headzoo\Core\Obj;

/**
 * @coversDefaultClass Headzoo\Core\Obj
 */
class ObjTest
    extends \PHPUnit_Framework_TestCase
{
    ...
    public function testToss_Interpolation_Defaults()
    {
        ...
        $this->assertEquals(
            "The class Headzoo\\Core\\Tests\\ObjTestClass threw an exception.", 
            $e->getMessage()
        );
        $this->assertEquals(0, $e->getCode());
        ...
        $this->assertEquals(
            "The class Headzoo\\Core\\Tests\\ObjTestClass threw a serious exception.",
            $e->getMessage()
        );
        $this->assertEquals(0, $e->getCode());
